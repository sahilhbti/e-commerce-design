...
jQuery(document).ready(function ($) {
    ...
    $("#appendButton").bind("click", AppendSlides);
    $("#removeButton").bind("click", RemoveSlides);
    $("#reloadButton").bind("click", ReloadSlides);
    $("#propertiesButton").bind("click", Properties);

    //$("#destroyButton").bind("click", DestroySlider);
